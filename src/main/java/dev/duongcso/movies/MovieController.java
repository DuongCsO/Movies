...
public class MovieController {
	...
	/*
	 * @GetMapping("/{id}") public ResponseEntity<Optional<Movie>>
	 * getSingleMovie(@PathVariable ObjectId id){ return new
	 * ResponseEntity<Optional<Movie>>(movieService.singleMovie(id), HttpStatus.OK);
	 * }
	 */
	@GetMapping("/{imbdId}")
